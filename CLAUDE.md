...
| the station on chat platforms (Telegram and the like), chat commands, the poller | [`docs/internals/messaging.md`](docs/internals/messaging.md) |
...
`station`, `messaging`. **`src/modules/modules.ts` is the source of
