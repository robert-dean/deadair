 ...
 */
export type SettingGroup = 'station' | 'stream' | 'housekeeping' | 'secrets' | 'rotation' | 'playout' | 'render' | 'llm' | 'analysis' | 'schedule';
 ...
 * generated from [StationSettingsInput](file://./../../../../../apps/api/data/contracts/settings/settings.types.ck#L39)
 */
 ...
 * generated from [StationSettingDescriptor](file://./../../../../../apps/api/data/contracts/settings/settings.types.ck#L26)
 */
 ...
 * generated from [StationSettings](file://./../../../../../apps/api/data/contracts/settings/settings.types.ck#L31)
 */
