...
import {
    ...
    newsItemFixture,
    newsQueryFixture,
    narrationSeriesFixture,
    narrationPieceFixture,
    narrationPartFixture,
    narrationTextFixture,
    narrationPiecesQueryFixture,
    narrationTextQueryFixture,
    podcastAudioFixture,
    podcastDirectoryEntryFixture,
    podcastDirectoryQueryFixture,
...
describe('plugin boundary conformance: positive fixtures', () => {
    it.each([
        ...
        ['LlmRequest', llmRequestFixture],
        ['LlmResult', llmResultFixture],
        ['LlmModelInfo', llmModelInfoFixture],
        ...
        ['PlaylistTracksRequest', playlistTracksRequestFixture],
        ...
        ['NewsFeedDescriptor', newsFeedDescriptorFixture],
        ['NewsQuery', newsQueryFixture],
        ['NewsItem', newsItemFixture],
        ['NarrationSeries', narrationSeriesFixture],
        ['NarrationPiece', narrationPieceFixture],
        ['NarrationPart', narrationPartFixture],
        ['NarrationText', narrationTextFixture],
        ['NarrationPiecesQuery', narrationPiecesQueryFixture],
        ['NarrationTextQuery', narrationTextQueryFixture],
        ['PodcastShow', podcastShowFixture],
        ['PodcastAudio', podcastAudioFixture],
        ['PodcastEpisode', podcastEpisodeFixture],
        ['PodcastEpisodesQuery', podcastEpisodesQueryFixture],
        ['PodcastDirectoryQuery', podcastDirectoryQueryFixture],
        ['PodcastDirectoryEntry', podcastDirectoryEntryFixture],
