...
import { breakPrompt, readAnswer, type BreakPromptShape } from './break.prompt.js';
...
export class ModelNewsBreakWriter extends BreakWriter {
    ...
    async write(request: BreakWriteRequest): Promise<WrittenBreak | undefined> {
        ...
        if (script === undefined) {
            this.logger.info('director: the model wrote nothing the station could read as news', {
