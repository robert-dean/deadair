            ...
            <Stack gap="md">
                <Stack gap="xxs">
                    ...
                    <Text size="sm" c="dimmed">
                        Link your account on a chat platform, such as Telegram, Discord or Slack, to skip a record or take the station off the air
                        from a chat. It can do only what you can.
                    </Text>
                </Stack>
                {links.error ? (
