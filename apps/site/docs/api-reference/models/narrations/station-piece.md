...
| `withdrawnAt`       | `string`               | No       | ISO-8601: when a refresh found its plugin no longer listing it. The station never picks a withdrawn piece; the row is kept so what was done with it is not lost |
