...
| `plugin.invoker.ts`                               | The only way host code calls plugin code: an 8s deadline per call (overridable per call, and published as the ambient deadline by `plugin.invocation.deadline.ts`) and a circuit breaker that quarantines a plugin after 3 consecutive failures, until a reinit or a healthy `probe` (the Test connection button) lifts it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
